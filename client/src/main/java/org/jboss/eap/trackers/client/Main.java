...
public class Main {
	...
	@CommandDefinition(name="whoami", description="Print current logged user information.")
	private static class WhoamiCommand implements Command<CommandInvocation> {

		@Override
		public CommandResult execute(CommandInvocation arg0) throws IOException {
			SecurityContext.printCurrentCrendentials();
