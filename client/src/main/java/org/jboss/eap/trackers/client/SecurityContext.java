...
public class SecurityContext {
	...
	public static void printCurrentCrendentials() {
		...
		// private credentials
		Set<Object> privVredentials = subject.getPrivateCredentials();
		for (Object o: privVredentials) {
			System.out.println("Private credentials: " + o.toString());
		}
		
		// public credentials
		Set<Object> pubVredentials = subject.getPublicCredentials();
		for (Object o: pubVredentials) {
			System.out.println("Public credentials: " + o.toString());
		}
	}
